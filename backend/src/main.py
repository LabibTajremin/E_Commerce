...
from src.presentation.api.v1.platform.master_password_audit import (
    router as platform_master_password_audit_router,
)
...
app.include_router(platform_master_password_audit_router, prefix="/api/v1/platform")
